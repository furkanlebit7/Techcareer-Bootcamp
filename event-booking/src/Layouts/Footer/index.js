...
const Footer = () => {
  return (
    <div className="bg-indigo-900 text-whiteMain">
      <div className="grid-cols-6 container  mx-auto grid  py-20">
        ...
        <div className="col-start-3 col-end-4 flex flex-col gap-6 justify-self-center">
        ...
        <div className="col-start-4 col-end-5 flex flex-col gap-6 justify-self-center">
        ...
        <div className="col-start-5 col-end-7 flex flex-col gap-6 justify-self-center">
          <h4 className="text-xl font-bold">Stay in the loop</h4>
          <p>
            Join our mailing list to stay in the loop with our newest for Event
            and concert
          </p>
          <div className="bg-white rounded-full py-2 px-3 flex items-center">
            <input
              type="text"
              placeholder="Enter your email address.."
              className="border-none flex-1 text-black  focus:ring-0"
            />
            <button className="bg-pinky py-2 px-3 rounded-full">
              Subscribe Now
            </button>
          </div>
        </div>
